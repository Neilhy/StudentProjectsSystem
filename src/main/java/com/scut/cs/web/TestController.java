...
//    }
    ...
    public Admin saveRole() {
        Admin a1 = new Admin(1L,"outer", "123456", "计算机学院", "ROLE_ADMIN");
...
//    }
    ...
    public Project saveProject() {
        ...
        Project project = new Project("腾讯创新大赛", "校级", "一等奖", "filepath","小刘","没有备注", new Date(time), "未审核", new ArrayList<Student>());
    ...
    public Student saveStudent() {
        ...
        Date date = Date.valueOf("2016-8-11");
        Project project1 = new Project("华为创新大赛", "校级", "一等奖", "filepath","小刘","没有备注", date, "未审核", null);
        Project project2 = new Project("华为创新大赛", "校级", "二等奖", "filepath","小刘","没有备注", date, "未审核", null);
        Project project3 = new Project("华为创新大赛", "校级", "三等奖", "filepath","小刘","没有备注", date, "未审核", null);
